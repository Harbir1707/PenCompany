...
namespace PenCompany.Controllers
{
    ...
    {
        private readonly PenCompanyContext _context;

        public PensController(PenCompanyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Price")] Pen pen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Genre,Price")] Pen pen)
        {
            if (id != pen.Id)
            {
                return NotFound();
